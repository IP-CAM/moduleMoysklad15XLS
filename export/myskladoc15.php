...
if (isset($request->get['mode']) && $request->get['type'] == 'sale') {
	...
	switch ($request->get['mode']) {
		case 'checkauth':
			$action = new Action('module/myskladoc15/modeCheckauth');
			break;

		case 'init':
			$action = new Action('module/myskladoc15/modeSaleInit');
			break;

		case 'query':
			$action = new Action('module/myskladoc15/modeQueryOrders');
			break;
